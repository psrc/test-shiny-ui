  ...
  moduleServer(id, function(input, output, session) { 
    ...
    output$banner <- renderUI({
      fluidRow(column(4, style = 'padding-left:50px; padding-right:0px;',
                      div(img(src = photo_filename, width = "100%", height = "100%", style = "padding-top: 0px; border-radius:0 0 30px 0;", alt = "Street Intersection with housing building in the background"))),
